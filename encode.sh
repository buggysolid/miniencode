...
FFMPEG_ENCODE_COMMAND="$FFMPEG_TARGET_DIRECTORY/ffmpeg -i $INPUT -vf scale=1280:720 -c:v libx265 -b:v 3800k -minrate 3800k -maxrate 3800k -bufsize 8096k -preset $PRESET -pass 1 -ac 2 -c:a aac -b:a 128k $OUTPUT_FILE_NAME"
