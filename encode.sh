...
FFMPEG_ENCODE_COMMAND="$FFMPEG_TARGET_DIRECTORY/ffmpeg -i $INPUT -vf scale=1280:720 -c:v libx265 -crf 28 -maxrate 3500k -bufsize 8096k -preset $PRESET -pass 1 -ac 2 -c:a aac -c:b 128k $OUTPUT_FILE_NAME"
